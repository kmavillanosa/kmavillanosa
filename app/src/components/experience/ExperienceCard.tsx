...
function ExperienceCard({ experience }: ExperienceCardProps) {
	...
	return (
		...
		>
			<Card className="h-full flex flex-col bg-white dark:bg-gray-800 border-stone-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden cursor-pointer">
			<div className="p-4 sm:p-6 flex flex-col h-full">
				{/* Header Section */}
				<div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-5">
					{experience.companyLogo && experience.companyLogo.trim() && (
						<div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-stone-50 to-stone-100 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center overflow-hidden shadow-sm border border-stone-200 dark:border-gray-700">
							<img
					...
					<div className="flex-1 min-w-0">
						<div className="flex items-start justify-between gap-2 mb-2">
							...
							<span className="px-2 py-0.5 text-xs font-medium bg-stone-100 dark:bg-gray-700 text-stone-700 dark:text-gray-300 rounded whitespace-nowrap flex-shrink-0">
								{experience.type}
							</span>
						</div>
						<p className="text-sm font-semibold text-stone-800 dark:text-gray-200 mb-1.5">
							{experience.position}
						</p>
				...
				<div className="flex items-center gap-2 mb-5 px-3 py-2 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
					<svg className="w-4 h-4 text-stone-500 dark:text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						...
						{Array.isArray(experience.responsibilities) 
							...
							<li key={index} className="flex items-start gap-2.5">
								<div className="flex-shrink-0 mt-0.5">
									<div className="w-1.5 h-1.5 rounded-full bg-stone-400 dark:bg-gray-500"></div>
								</div>
