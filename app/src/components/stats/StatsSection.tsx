	...
	if (loading) {
		return (
			<section id="stats-section" className="py-10 sm:py-12 px-4 sm:px-6 bg-theme-elevated">
				<div className="max-w-5xl mx-auto flex justify-center items-center min-h-[240px]">
					<Spinner size="xl" />
				</div>
			</section>
		)
			...
			<div className="max-w-5xl mx-auto">
				<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5">
					{stats.map((stat, index) => (
						<div
							key={index}
							className="bg-theme-surface rounded-lg p-5 border border-theme text-center"
						>
							...
							<div className="text-2xl sm:text-3xl font-bold text-theme-text-primary tabular-nums">
								{stat.value}
							</div>
							<div className="text-sm font-semibold text-theme-text-secondary mt-0.5">
								{stat.label}
							</div>
