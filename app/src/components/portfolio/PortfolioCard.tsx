		...
		>
			...
			>
				...
				<div className="h-48 w-full overflow-hidden bg-stone-100 dark:bg-gray-700 relative flex-shrink-0">
					{previewIframe ? (
						...
						<div className="h-full w-full flex items-center justify-center">
							<svg className="w-12 h-12 text-stone-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				...
				<div className="p-4 sm:p-5 flex-1 flex flex-col">
					...
					{page.description && (
						<p className="font-normal text-stone-600 dark:text-gray-400 line-clamp-3 mb-3 flex-1 text-sm leading-relaxed">
							{page.description}
						</p>
					)}
					{(page.tags || page.technologies) && (
						<div className="flex flex-wrap gap-1.5 mb-3">
							...
							{((page.tags || page.technologies || []).length > 4) && (
								<span className="px-2 py-0.5 text-xs font-medium rounded-md bg-stone-100 dark:bg-gray-700 text-stone-600 dark:text-gray-400">
									+{((page.tags || page.technologies || []).length - 4)}
								</span>
							)}
						</div>
					...
					{page.date && (
						<div className="flex items-center gap-2 mt-auto pt-3 border-t border-stone-200 dark:border-gray-700">
